...
- BlueOcean版jenkins(推荐): `docker run -u root --rm -d -e TZ="Asia/Shanghai -p 8080:8080 -p 50000:50000 -v jenkins_home:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock jenkinsci/blueocean`
