...
- 在URL中填写jenkins提供的webhook接口
- 为了避免频繁的发送,只有在特定的几个状态时才发送
...
3. 方案二
为方便大家使用,笔者在github中创建了支持此功能的share library.
